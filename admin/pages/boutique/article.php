                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="text-capitalize"><a href="/admin/pages/boutique/edit.php?id=<?= $article['idArticle'] ?>"><?= $article['titleArticle'] ?></a></td>
                            <td><?= str_replace(".", ",", $article['priceArticle']); ?> €</td>
                            <td><?= $article['creditGiveArticle']; ?></td>
                          </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
